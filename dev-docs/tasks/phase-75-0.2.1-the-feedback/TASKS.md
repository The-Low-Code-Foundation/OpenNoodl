...
- 🟢 **FB-016** — box-model overlay, radius-following highlight: **BUILT AND DRIVEN 2026-08-25**, AC1–AC4 met. Scope 4 (transform-origin crosshair) deliberately left — it is the one scope needing an editor-side focus hook
  (M/L)
