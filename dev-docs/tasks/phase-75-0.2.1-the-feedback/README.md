...
| §6 transform-origin crosshair | **Real** — nothing marks the origin. ⚠️ **The one part of FB-016 still open** after 2026-08-25: every other scope lives in the viewer, this one needs the editor to say when the field has focus | FB-016 (scope 4) — **open** |
