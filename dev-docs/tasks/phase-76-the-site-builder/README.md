...
| SB-008 | **The drive** | An agent builds a page end-to-end through the admin panel in the running app; verify the consequence (published page renders for an anonymous visitor; unpublished 404s), not the mechanism. |
