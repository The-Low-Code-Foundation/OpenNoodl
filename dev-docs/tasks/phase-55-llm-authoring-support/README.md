...
| F9 | `render-from-disk.js` forces `plug: 'input'` on Component Inputs ports — it will certify a page the editor cannot render. Fix in the `render_report` promotion | 🔴 OPEN → **LAS-005** |
