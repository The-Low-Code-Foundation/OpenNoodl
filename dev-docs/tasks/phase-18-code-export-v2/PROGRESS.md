...
**Last updated:** 2026-08-27 (second session)
**Overall status:** 🟡 In progress — 1 / 7 tasks built (EXP-001); EXP-002 steps 1–4 done (IR, hand-written target, walking skeleton, visual-node generator — PuppyCard golden matches byte-for-byte, emitted app builds and renders)
