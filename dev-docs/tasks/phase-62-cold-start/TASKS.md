...
| BST-003 | [BST-003-THE-ON-RAMP-BEFORE-THERE-IS-A-PROJECT.md](BST-003-THE-ON-RAMP-BEFORE-THERE-IS-A-PROJECT.md) | the launcher offers the connection with zero projects | ✅ **built 2026-08-11** — decision settled B-then-C off F14; ⚠️ **card never rendered** |
