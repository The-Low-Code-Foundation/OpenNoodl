...
| Nodes fully audited against the 12 checks | **79** | 15 of 17 categories: Variables, Logic, Math, Events, String Manipulation, Interpolation, Javascript, Sensors, Cloud Services, Navigation, **Component Utilities, Utilities, CustomCode (4 of 5), Animation, Cloud**. `Logic Builder` read but **blocked** — another session has held the file uncommitted for nine handovers |
...
| Animation | 4 / 4 | **4** | **10** |
| Cloud | 3 / 3 | **3** | 4 |
| **15 of 17 categories** | **79 / 155** | **66** | **110** |

**Animation took the record at 2.50 per node, CustomCode second at 2.00, and the running average is
now 1.39 across 79 nodes.** Three categories in this batch have *every* node carrying at least one
defect (Animation, CustomCode, Cloud), joining Navigation.
