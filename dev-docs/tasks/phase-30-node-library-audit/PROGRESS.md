...
| Cloud | 3 / 3 | **3** | 4 |
| **Data** | **37 / 37** | **29** | **32** |
| **16 complete — only Visual (29) remains** | **116 / 151** | **96** | **148** |
...
- **2026-08-01 (NDA-012 Data — CLOSED at 37/37, by a four-worker parallel batch).** The previous
  ...
  **29 nodes read, 26 new defects, 13 fixed and 13 filed. Data is 37/37 and only Visual (29)
