...
| Nodes fully audited against the 12 checks | **80** | 15 of 17 categories, **all complete**: Variables, Logic, Math, Events, String Manipulation, Interpolation, Javascript, Sensors, Cloud Services, Navigation, Component Utilities, Utilities, **CustomCode (5 of 5)**, Animation, Cloud. Nothing is blocked; only **Data (42 in scope of 46 — four deprecated dropped 2026-07-31)** and **Visual (29)** remain |
