...
7 inputs / 2 outputs · 3 signal in / 1 signal out · docs 0% · SSR `safe` · browser, cloud

Source: _(fill in)_ · Docs: [link](https://docs.noodl.net/nodes/math/counter)
...
6 inputs / 1 outputs · 0 signal in / 0 signal out · docs 0% · SSR `safe` · browser

Source: _(fill in)_ · Docs: [link](https://docs.noodl.net/nodes/math/number-remapper)
