...
| V5 | No gradient/image-ground/opacity/layering anywhere in the sanctioned vocabulary | VOCABULARY | VIB-002 | 🔴 open |
| V6 | Zero marketing compositions of 26 | VOCABULARY | VIB-004 | 🔴 open |
| V7 | Templates cannot/do not ship assets; all example images are `src:""` | CORPUS | VIB-003 | 🔴 open |
...
| V13 | Doctrine talks display type down to 48px; no responsive type story | VOCABULARY/INSTRUCTION | VIB-002 | 🔴 open |
