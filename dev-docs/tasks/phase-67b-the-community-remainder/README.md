...
| **UNI-013 slice 4** | 🔴 **The twelve badge artworks — RICHARD'S, and not code** | The profile renders a family mark and a tier colour rather than a broken image. That was the point of doing it that way |
...
6. 🔴 **UNI-013 slice 4 is Richard's and is not code.** It does not block anything.
