...
**Code export is alpha, and says so.** 111 of the 127 nodes you can place from the picker export
today (87%). The other 16 are badged *Not exportable yet* on the picker card and in the property
