...
**Code export is alpha, and says so.** 105 of the 127 nodes you can place from the picker export
today (82%). The other 22 are badged *Not exportable yet* on the picker card and in the property
