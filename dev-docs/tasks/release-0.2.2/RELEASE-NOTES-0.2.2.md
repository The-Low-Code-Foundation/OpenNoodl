...
**Code export is alpha, and says so.** 116 of the 127 nodes you can place from the picker export
today (91%). The other 11 are badged *Not exportable yet* on the picker card and in the property
