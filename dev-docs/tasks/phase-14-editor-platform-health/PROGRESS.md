...
| PLAT-002 | Retire the jQuery islands | In progress (2026-07-24) | 6–8 wks | 547 → 379 `$(` calls. Dead code deleted (projectsview 922 ln, newupdatepopup, 11 orphan templates); 15 DataTypes rows converted to React (idiom: PickerTypeView/PropertyPanel* + onReset + data-identifier restored). Next: NOTES §8 handoff (IconType, TextStyleType, composite views, hosts, PopupLayer) |
