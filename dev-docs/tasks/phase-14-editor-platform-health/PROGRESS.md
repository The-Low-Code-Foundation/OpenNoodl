...
| PLAT-002 | Retire the jQuery islands | In progress (2026-07-24) | 6–8 wks | Baseline 547 `$(` / 68 files. Inventory + wave plan in PLAT-002-NOTES.md; projectsview + newupdatepopup found dead (deleted, not converted) |
