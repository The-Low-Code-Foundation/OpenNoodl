...
| 7 | [OPS-008](./OPS-008-PROJECT-JOURNAL.md) | The project journal & `query_context` | 4 — the narrative | 🟠 High | ~1 wk | none | 🔵 Fable 5 |
| 8 | [OPS-009](./OPS-009-AUTHORING-BUDGET.md) | Authoring budget & circuit breakers | 4 — the narrative | 🟡 Medium | 4–6 days | none | 🟢 Sonnet 5 |

Serial worst case ~9 weeks; realistic with parallelism ~5. OPS-002, OPS-003 and OPS-007 have disjoint
