...
| ⚠️ **`parsePocketbaseSchema` recovers NO fields at all from PocketBase 0.23+** — it reads `collection.schema`, which that release renamed to `fields`. Found by BCN-005 | **unowned — editor territory** |
