...
| **[NAT-012](NAT-012-THE-DOOR-NOT-THE-EXIT.md)** | 🟡 **The door, not the exit.** ✅ **AC2 audit, AC3 and AC4 done + the editor narrowing (`e17ee460`, `39404361`)** — the panel draws Discussions, the two panes and TUT-004's tutorials; People/Guides/Replays/health went to the launcher; the door says it closes your project and reopening restores your component. ⬜ **Left: AC1** (back/forward across surfaces), **AC5**, **AC6** (route sweep + drive), **AC7** (the rail icon for a refused viewer) — **and a drive of AC3/AC4** | editor / core-ui | **4** | M | ✅ **D6 and AC3 both ruled 2026-08-22.** 🔴 A route is outside every sweep — derive from disk, drive it |
