...
> write is unblocked. ⚠️ The device flow's *consent copy* still says identity; rewording it is a
> follow-up the ruling created and NAT-007 should carry.
...
| **[NAT-009](NAT-009-WORK-YOU-CAN-TAKE-FROM-THE-EDITOR.md)** | **Work you can take from the editor.** The RFP board, browsable and **answerable** from the tool the qualified person is already sitting in | editor / platform | **3** | M/L | NAT-005, NAT-006. ✅ D5 settled 08-20. 🔴 The relay's `'relayed'` outcome + the missing drainer |
