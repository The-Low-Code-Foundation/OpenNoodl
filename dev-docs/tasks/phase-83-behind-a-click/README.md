...
**Status: OPEN — HLS-011 IS DRIVEN, so §6's end condition is MET; 13 of 15 built, 45 acceptance criteria closed. What is left is HLS-015 and HLS-014, both gated on R4, plus Richard's items in the handoff §2.**
