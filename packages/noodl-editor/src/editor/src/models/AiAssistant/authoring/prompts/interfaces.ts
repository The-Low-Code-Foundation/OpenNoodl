 ...
 * examples an agent learns from, **10%** publish any `Component Outputs`; of the
...
**Why this is written down.** Across the examples an agent learns from, **10%** of components publish
