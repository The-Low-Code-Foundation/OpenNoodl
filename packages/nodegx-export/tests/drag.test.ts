...
describe('§A the fixture, whole — a card in a bounded board, four live reads, three listeners, two snaps', () => {
  ...
  test('A8 the ledger row moved, so the picker card carries no badge; the floor is 106', () => {
    ...
    expect(ledger.pickerCoverageFloor).toBe(106); // §63 Drag (session 86) on top of §57 + §58 + §59 (session 85)
  });
