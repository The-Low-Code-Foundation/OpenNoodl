...
describe('§H the ledger', () => {
  test('the three are translated, carry no badge, and the floor is 105', () => {
    ...
    expect(ledger.pickerCoverageFloor).toBe(106); // §63 Drag (session 86) // §57 Repeater Item, §58 the streaming trio, §59 Hash / Random Bytes / Screen Resolution (session 85)
  });
});
